...
def build_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    p_create.add_argument(
        ...
        help="Local profile or remote peer:<peer>/<profile> target",
    )
    ...
    p_assign.add_argument(
        "profile",
        help="Local profile or peer:<peer>/<profile> (or 'none' to unassign)",
    )
    ...
    p_reassign.add_argument(
        "profile",
        help="New local profile or peer:<peer>/<profile> (or 'none' to unassign)",
    )
    p_reassign.add_argument(
...
def _cmd_dispatch(args: argparse.Namespace) -> int:
    ...
    if getattr(args, "json", False):
        print(json.dumps({
            ...
            "peer_recovered": res.peer_recovered,
    ...
    print(f"Peer recovered: {len(res.peer_recovered)}")
    if res.peer_recovered:
        print(f"  {', '.join(res.peer_recovered)}")
...
def _cmd_daemon(args: argparse.Namespace) -> int:
    ...
    def _on_tick(res):
        ...
        did_work = (
            ...
            or res.spawned or res.auto_blocked or res.peer_recovered or res.stale
        )
        if did_work:
            print(
                ...
                f"peer_recovered={len(res.peer_recovered)}",
                flush=True,
            )
